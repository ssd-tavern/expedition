...
`;
  ...
  const OPENINGS_META = [
    ...
    { who: '古德瑟', act: '第二幕', role: '幽冥号助理外科医生、博物学家', img: 'https://files.catbox.moe/ho0u3f.png', blurb: '一八四五年九月，比奇岛越冬在即。你搬木料豁开了手臂，头一回踏进医务室，给你缝针的是全船最年轻的军官' },
    ...
    { who: '古德瑟', act: 'if线一', line: 'if验铅', role: '幽冥号助理外科医生', img: 'https://files.catbox.moe/brb9ur.png', blurb: '一八四七年十一月，第三冬合拢。深夜古德瑟把你叫进满地病历的医务室，她说船队的毒不在冰里，在货舱里' },
  ...
  async function startCustomOpening() {
    ...
    try {
      ...
      const stat = {
        ...
        狩猎技巧: 0,
        名册: {},
        好感: Object.assign({ 富兰克林: 0, 克洛泽: 0, 菲茨: 0, 瑙雅: 0, 茜拉: 0, 古德瑟: 0 }, stage.affinity || {}),
        心声: {}, 回想: {},
